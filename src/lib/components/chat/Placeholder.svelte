	...
	>
		<div class="w-full flex flex-col justify-center items-center">
			<div class="flex flex-row justify-center gap-3 @sm:gap-3.5 w-fit px-5 ">
							...
							>
								...
								>
									<img
										...
										class=" size-9 @sm:size-10 bg-transparent rounded-full border-[1px] border-gray-200 dark:border-none"
										alt="logo"
										draggable="false"
									/>
								</button>
				...
				<div class=" text-3xl text-black @sm:text-4xl capitalize " in:fade={{ duration: 100 }}>
